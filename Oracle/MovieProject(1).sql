...
CREATE TABLE missing (
	...
	mi_owner VARCHAR2(10), /* 수령인 */
	mi_hp VARCHAR2(20) /* 전화번호 */
);
...
/* 관람등급 */
CREATE TABLE rank (
	rank_no NUMBER(10) NOT NULL, /* 등급번호 */
	rank_name VARCHAR2(20) /* 등급이름 */
);
