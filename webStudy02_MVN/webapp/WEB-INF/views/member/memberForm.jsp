...
<script type="text/javascript"
   src="${pageContext.request.contextPath }/resources/js/jquery.validation/jquery.validate.min.js"></script>
   ...
   <form method="post" id="memberForm">
      <table class="table table-bordered">
         ...
         <tr>
            <th>주소2</th>
            <td><input class="form-control" required type="text"
               name="memAdd2" value="<%=member.getMemAdd2()%>" /><span><%=errors.get("memAdd2")%></span></td>
         </tr>
         <tr>
            <th>집전번</th>
         ...
         <tr>
            <th>이메일</th>
            <td><input class="form-control" required type="text"
               name="memMail" value="<%=member.getMemMail()%>" /><span><%=errors.get("memMail")%></span></td>
         </tr>
         <tr>
            <th>직업</th>
